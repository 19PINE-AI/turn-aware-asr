...
\paragraph{Offline ASR regression.} \pending{E12: LibriSpeech test-clean/other WER, stock Qwen3-ASR-0.6B vs merged endpoint checkpoint, plus marker false-fire rate on offline clips (causally, the v9 model should rarely fire on silence-free clips). One-row table; runs are queued.}
