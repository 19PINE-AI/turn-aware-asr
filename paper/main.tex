...
\label{app:tables}
Ungated arms, the full confirm-horizon sweep ($h{\in}\{0,1,2\}$; $h{=}2$ over-suppresses), per-stretch distributions, and the fresh-set E13 table will be included here. \pending{E13 table; final per-arm JSON digests}
